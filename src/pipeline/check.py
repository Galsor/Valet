...
from src.utils.constants import GENERATIVE_MODEL, MAX_LENGTH, DOC_RELEVANCE_CHECK_TEMPLATE
...
def get_validate_documents_node() -> PromptNode:
    ...
    return PromptNode(prompt_open_ai, default_prompt_template=doc_relevance_prompt, output_variable="relevant_doc_ids")
